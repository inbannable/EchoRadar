param(
    ...
    [string]$WorkRoot = "ml\generated\v4",
    [string]$ModelOutput = "models\v4-candidate",
    [int]$Epochs = 20,
    [int]$BatchSize = 64,
    [int]$Threads = 0
)
...
if (-not (Test-Path $Python)) {
    throw "Missing ml virtual environment. Follow ml\TRAINING_V4.md first."
}
...
$EvaluationOutput = Join-Path "ml\runs" "v4-candidate"
